    ...
    <div className="flex flex-col gap-6 w-full text-slate-800">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl font-extrabold text-[#0F172A] tracking-tight">Issuance Queue</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex items-center gap-4 transition-all duration-300 hover:border-[#005c55]">
              ...
              <div>
                ...
                <p className="text-xl font-extrabold text-[#0B1C30]">{kpis.stockCritical} Items</p>
              </div>
            </div>
                    ...
                    {filteredRequests.map((r) => {
                      ...
                      return (
                        <Tr key={r.id}>
                          <Td
                            pinned
                            className="font-bold font-mono text-[#005c55] text-[13px] leading-none"
                          >
                            {r.reference_number}
                          </Td>
                          ...
                          <td className="px-6 py-3.5 text-center">
                            {stockStatus === "FULL_STOCK" ? (
                              <span className="inline-flex items-center gap-1 text-[10px] text-teal-700 bg-teal-50 border border-teal-100 rounded-full px-2 py-0.5 font-bold">
                                <span className="w-1.5 h-1.5 rounded-full bg-teal-600"></span> Fully
                                Stocked
                              </span>
                            ) : (
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-white border border-slate-200 shadow-sm rounded-xl p-6 flex flex-col gap-4">
              <div className="border-b border-slate-100 pb-3">
                ...
                <p className="text-[11px] text-slate-400 mt-1 font-semibold">
                  Ensure security identity checks and transport details are recorded legally before
                  dispatch.
                </p>
              </div>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex gap-3 text-xs text-amber-850 mt-1">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-[11px] text-amber-700 font-medium">
                      One or more line items have issued quantities below the initial SBU requested
                      levels. Shortfall reasons must be recorded for auditing and automated order
                      split resolution.
                    </p>
                  </div>
                </div>
