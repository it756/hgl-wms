...
async function main() {
  ...
  const products = [
    ...
    {
      name: "Base Shelf 1000Mm 800/350 +14Pcs",
      sku: "JARA-SHF-009",
      unit_of_measure: "unit",
      stock_quantity: 90,
      low_stock_threshold: 5,
    ...
    {
      name: "Clothing Display Rack",
      sku: "EJBL-001",
      unit_of_measure: "unit",
      stock_quantity: 50,
      low_stock_threshold: 5,
      unit_cost: null,
      warehouse_location: "N1",
    },
    {
      name: "Plastic Clothes Hangers (Box/50)",
      sku: "EJBL-002",
      unit_of_measure: "box",
      stock_quantity: 200,
      low_stock_threshold: 20,
    ...
    {
      name: "Full-Length Fitting Mirror",
      sku: "EJBL-003",
      unit_of_measure: "unit",
      stock_quantity: 20,
      low_stock_threshold: 2,
    ...
    {
      name: "Heavy Duty Safety Gloves (Pair)",
      sku: "OTBR-004",
      unit_of_measure: "pair",
      stock_quantity: 120,
      low_stock_threshold: 12,
